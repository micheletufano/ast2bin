...
public class MethodInvocation extends BinaryBuilderComponent{
	...
	private static void buildHeader(BinaryVertex parent, List<BinaryVertex> siblings, BinaryTree tree){
		org.eclipse.jdt.core.dom.MethodInvocation node = (org.eclipse.jdt.core.dom.MethodInvocation) parent.getNode();
	...
	private static List<BinaryVertex> getTypes(org.eclipse.jdt.core.dom.MethodInvocation node, List<BinaryVertex> siblings){
