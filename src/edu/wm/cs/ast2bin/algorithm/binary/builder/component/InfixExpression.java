...
public class InfixExpression extends BinaryBuilderComponent{
	...
	public static void convertToBinary(BinaryVertex vertex, BinaryTree tree) {
		...
		nextParent.setType(Type.INFIX_EXPRESSION_LIST);
		...
		//Recursion
		buildList(nextParent, child, siblings, tree, Type.INFIX_EXPRESSION_LIST);
