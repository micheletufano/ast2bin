...
public class ConstructorInvocation extends BinaryBuilderComponent{
	...
	public static void convertToBinary(BinaryVertex vertex, BinaryTree tree) {
		...
		nextParent.setType(Type.ARGUMENT_LIST);
		...
		//Recursion
		buildList(nextParent, child, siblings, tree, Type.ARGUMENT_LIST);
